function [L,u0,n] = connectomelaplacian_fsl(csize,csource,cthreshold,cweight)
%  ---------------------------------------------------
%
...
cf = pwd;
filenameoffice = [cf,'\Connectomes\FSL-probabilistic\Scale-',num2str(csize(1)),'\',csource,'\',num2str(cthreshold),'\',weight,'.csv'];
